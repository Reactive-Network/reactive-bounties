...
async function main() {
  ...
  const tokenOutContract = new ethers.Contract(process.env.TOKEN_OUT_ADDRESS, TOKEN_ABI, provider);
  ...
  // Parse amounts using the correct number of decimals
  ...
  console.log('Calling approveSwapWithPermit...');
